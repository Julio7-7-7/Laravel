...
<body class="flex flex-col items-center justify-center min-h-screen bg-blue-100">
    ...
    <header class="w-full bg-blue-800 py-6 px-6 shadow-md relative flex items-center justify-center">
        ...
        <a href="{{ route('categoria.index') }}" class="absolute left-6 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-300">
        ...
        <!-- Título centrado -->
        <h1 class="text-white text-3xl font-bold">Editar Categoria</h1>
    </header>
                ...
                <form action="{{route('categoria.update',$categoria->id)}}" method="post">
                    ...
                    <div class="relative">
                        <select
                            ...
                            <option value="egreso"{{ old('categoria', $categoria->tipo) == 'egreso' ? 'selected' : '' }}>Egreso</option>
                            <option value="ingreso"{{ old('categoria', $categoria->tipo) == 'ingreso' ? 'selected' : '' }}>Ingreso</option>
