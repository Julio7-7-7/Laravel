...
<head>
    ...
    <title>Registros economicos</title>
...
<body class="antialiased">
    <div class="min-h-screen bg-gray-100 flex flex-col items-center">
        ...
        <header class="w-full header-blue py-6 px-6 shadow-md relative flex items-center justify-center">
            ...
            <!-- Título centrado -->
            <h1 class="text-white text-3xl font-bold">Registros económicos</h1>
        </header>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-blue-50 transition duration-150">
                                <td class="py-3 px-4 whitespace-nowrap text-sm text-gray-800">{{$registro->id}}</td>
                                <td class="py-3 px-4 whitespace-nowrap text-sm text-gray-600">{{$registro->descripcion}}</td>
                                <td class="py-3 px-4 whitespace-nowrap text-sm text-gray-600">{{\Carbon\Carbon::parse($registro->fecha)->format('d/m/Y')}}</td>
                                <td class="py-3 px-4 whitespace-nowrap text-sm text-gray-600">{{$registro->monto}}</td>
                                <td class="py-3 px-4 whitespace-nowrap text-sm text-gray-600">{{$registro->categoria->tipo}}</td>
