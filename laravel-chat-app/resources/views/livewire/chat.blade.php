<div class="relative mb-6 w-full">
    ...
    <flux:subheading size="lg" class="mb-6">{{ __('Observa tus chats aquí') }}</flux:subheading>
        ...
        <div class="w-3/4 flex flex-col">
            ...
            <form wire:submit="submit" class="p-4 border-t bg-white flex items-center gap-2">
                <input type="text" wire:model="newMessage"
                    class="flex-1 border border-gray-300 rounded-full px-4 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring focus:ring-blue-300 bg-white"
